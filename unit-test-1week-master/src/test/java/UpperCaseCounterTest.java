...
public class UpperCaseCounterTest {
    ...
    public void getNumberOfUpperCaseCharactersInString_return_10_for_ABCDEFGHIJ() {
        ...
        assertTrue(numberOfUpperCaseCharactersInString == 10); //assertTrue로 맞는 테스트 코드 작성
        assertFalse(numberOfUpperCaseCharactersInString == 9); //assertFalse로 틀리는 값을 넣어 테스트 작성
        assertThat(numberOfUpperCaseCharactersInString, is(10)); //assertThat 단정문을 사용해서 True인 테스트 코드 작성
    }
    ...
    public void getNumberOfUpperCaseCharacterInString_return_6_for_ABCdefGHI(){
        ...
        assertTrue(result == 6); //assertTrue로 맞는 테스트 코드 작성
        assertFalse(result == 5); //assertFalse로 틀리는 값을 넣어 테스트 작성
        assertThat(result,is(6)); //assertThat 단정문을 사용해서 True인 테스트 코드 작성
